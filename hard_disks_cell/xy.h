...
double dist(const XY &c1, const XY &c2);

// same as dist2, but with periodic boundary conditions
double dist_pbc(const XY &c1, const XY &c2, double L);


// returns the distance squared
double dist_sq(const XY &c1, const XY &c2);

// same as dist2_sq, but with periodic boundary conditions
double dist_sq_pbc(const XY &c1, const XY &c2, double L);
