...
int main()
{
	...
	unsigned int ncell_per_dim = config.get_parameter<unsigned int>("ncell");
	...
	System system(N,L,d,ncell_per_dim);
	system.initialize();

	cout << system.positions[0] << endl;
	cout << system.particle_cell[0] << endl;
